...
const ROLES = ["admin", "seo", "readonly"];
const ROLE_LABELS = { admin: "Admin", seo: "SEO Manager", readonly: "Read-Only" };
const ROLE_COLORS = { admin: "#4836FE", seo: "#10B981", readonly: "#6B7280" };

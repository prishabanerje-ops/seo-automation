...
const ROUTE_META = {
  ...
  "/admin":                 { trail: ["Projects", "Admin View"], title: "Admin View" },
...
const ROLE_COLORS = { admin: "#10B981", founder: "#10B981", seo: "#6366F1", readonly: "#94A3B8" };
const ROLE_LABELS = { admin: "Admin", founder: "Admin", seo: "SEO", readonly: "Read-only" };
